...
test "invalid continuation byte" {
    ...
    utf8Error("\"\xe4\x80\x10\"");
    utf8Error("\"\xe4\x80\xc0\"");
    utf8Error("\"\xe4\x80\xf5\"");
    utf8Error("\"\xe4\x00\x80\"");
    utf8Error("\"\xf2\x00\x80\x80\"");
    utf8Error("\"\xf2\x80\x00\x80\"");
    utf8Error("\"\xf2\x80\xc0\x80\"");
    utf8Error("\"\xf2\x80\x80\x00\"");
    utf8Error("\"\xf2\x80\x80\xc0\"");
    utf8Error("\"\xf2\x80\x80\xf5\"");
}

test "disallowed overlong ascii" {
    utf8Error("\"\xc0\x80\"");
    utf8Error("\"\xc0\x90\"");
    utf8Error("\"\xc1\x80\"");
    utf8Error("\"\xc1\x90\"");
